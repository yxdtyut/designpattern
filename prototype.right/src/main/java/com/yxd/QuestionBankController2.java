...
public class QuestionBankController2 {
    ...
    public QuestionBankController2() {
        ...
        paper.append(new ChoiceQuestion("JAVA所定义的版本中不包括", map01, "D"))
    ...
    public String createPaper(String candidate, String number) throws CloneNotSupportedException {
        ...
        clonePaper.setCandidate(candidate);
        clonePaper.setNumber(number);
        return clonePaper.toString();
    }
}
